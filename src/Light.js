        ...
        <main className="careGuide">
            ...
            <h1> Light for your Indoor Plants</h1>
              ...
              <p>This guide is a brief overview of the relationship between light and houseplants. It discusses some essential concepts about light, like how</p>
                    ...
                    <p>
                        <strong>Hours of sun hitting the leaves:</strong> 8+ hours
                    </p>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>Ficus Elastica (Rubber Plant)
                        </li>
                        <li>Ficus Microcarpa
                        </li>
                        <li>Ficus Alii
                        </li>
                        <li>Strelitzia Nicolai (Bird of Paradise)
                        </li>
                        <li>Ponytail Palm
                        </li>
                        <li>Jade Plant 
                        </li>
                        <li>Olea Europaea (Olive Tree)
                        </li>
                        <li>Yucca Gigantea
                        </li>
                    </ul>
...
<ul>
                        ...
                        <li>Pachira Aquatica (Money Tree)
                        </li>
                        <li>Peperomias
                        </li>
                        <li>Begonia Maculata
                        </li>
                        <li>Syngonium Podophyllum (White Butterfly)
                        </li>
                    </ul> 
                    <h3>
                        Shade
                    ...
                    <p>
                         Monstera Deliciosa, Monstera Adansonii, Philodendron, Calatheas, Maranta Leuconeura (Prayer Plant), 
                    </p>
                    <h3>
                        Low Light
                    </h3>
...
<ul>
                    ...
                    <p>
                        ...
                        the first generation of light bulbs. An incandescent bulb gives off a warm yellow colour when lit. The light comes from electricity running through a filament inside the bulb. Incandescent bulbs are cheaper than any other bulb, but they only last for 750-2,500 hours. 
                    </p>
                    <p>
                    ...
                    <ol>
                        <li>
                            ...
                            The biggest benefit of LEDs is actually their efficiency. Depending on the light they can produce the equivalent light of an incandescent, fluorescent, or HID bulb using 10% of the energy. 
                        </li>
                        <li>
                            <strong>They are easier on the eyes in our homes:</strong>
                            They can be adjusted to create specific temperatures of light without negatively impacting their ability to support plant growth. 
                        </li>
                        <li>
                            <strong>They produce less heat: </strong>
                            Old school grow lights will make you sweat. 
                        </li>
                    </ol>
                    <p></p>
                    <h3>
